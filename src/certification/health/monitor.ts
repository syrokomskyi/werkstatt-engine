/*
<MODULE_CONTRACT>
<purpose>health monitor — track certification subsystem health signals and report degradation.</purpose>
<non-goals>
  <item>Do not certify — the monitor only reports health.</item>
</non-goals>
</MODULE_CONTRACT>
<CHANGE_SUMMARY>
