/*
<MODULE_CONTRACT>
<purpose>action-pack — certification action pack types and failure contracts for gate remediation.</purpose>
<non-goals>
  <item>Do not execute actions — this module defines the pack contract only.</item>
</non-goals>
</MODULE_CONTRACT>
<CHANGE_SUMMARY>
