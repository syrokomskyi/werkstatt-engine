/*
<MODULE_CONTRACT>
<purpose>certification index — re-export the certification subsystem public surface for consumers.</purpose>
<non-goals>
  <item>Do not implement certification logic here — it lives in sibling modules.</item>
</non-goals>
</MODULE_CONTRACT>
<CHANGE_SUMMARY>
