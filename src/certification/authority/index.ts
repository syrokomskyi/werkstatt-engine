/*
<MODULE_CONTRACT>
<purpose>certification authority index — re-export the issuer registry public surface for consumers.</purpose>
<non-goals>
  <item>Do not implement registry logic here — it lives in sibling modules.</item>
</non-goals>
</MODULE_CONTRACT>
<CHANGE_SUMMARY>
