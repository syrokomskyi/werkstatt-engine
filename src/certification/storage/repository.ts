/*
<MODULE_CONTRACT>
<purpose>storage repository — dossier repository over the storage adapter port.</purpose>
<non-goals>
  <item>Do not access storage directly — the repository is the seam.</item>
</non-goals>
</MODULE_CONTRACT>
<CHANGE_SUMMARY>
