/*
<MODULE_CONTRACT>
<purpose>orchestrator — drive certification runs through their state machine to a terminal verdict.</purpose>
<non-goals>
  <item>Do not evaluate checks — the orchestrator coordinates, evaluators decide.</item>
</non-goals>
</MODULE_CONTRACT>
<CHANGE_SUMMARY>
