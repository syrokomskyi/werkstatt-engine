/*
<MODULE_CONTRACT>
<purpose>legacy-artifacts cleanup — remove superseded certification artifacts under a cleanup mode.</purpose>
<non-goals>
  <item>Do not delete current artifacts — cleanup targets legacy outputs only.</item>
</non-goals>
</MODULE_CONTRACT>
<CHANGE_SUMMARY>
