/*
<MODULE_CONTRACT>
<purpose>evidence-selection — select certification evidence within the configured size and count limits.</purpose>
<non-goals>
  <item>Do not produce evidence — selection picks from produced evidence.</item>
</non-goals>
</MODULE_CONTRACT>
<CHANGE_SUMMARY>
