/*
<MODULE_CONTRACT>
<purpose>cutover marker — clean-cutover marker type written when certification cutover completes.</purpose>
<non-goals>
  <item>Do not perform the cutover — this module only defines the marker.</item>
</non-goals>
</MODULE_CONTRACT>
<CHANGE_SUMMARY>
