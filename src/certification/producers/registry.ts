/*
<MODULE_CONTRACT>
<purpose>producers registry — register certification evidence producers keyed by kind.</purpose>
<non-goals>
  <item>Do not produce evidence — the registry only maps kinds to producers.</item>
</non-goals>
</MODULE_CONTRACT>
<CHANGE_SUMMARY>
