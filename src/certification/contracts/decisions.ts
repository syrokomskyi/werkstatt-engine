/*
<MODULE_CONTRACT>
<purpose>decisions contract — Zod schemas for certification coverage reports and gate decisions.</purpose>
<non-goals>
  <item>Do not make gate decisions — this module defines the contract only.</item>
</non-goals>
</MODULE_CONTRACT>
<CHANGE_SUMMARY>
