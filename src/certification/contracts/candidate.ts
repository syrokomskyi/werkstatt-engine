/*
<MODULE_CONTRACT>
<purpose>candidate contract — Zod schemas for certification candidate build configuration.</purpose>
<non-goals>
  <item>Do not build candidates — this module defines the contract only.</item>
</non-goals>
</MODULE_CONTRACT>
<CHANGE_SUMMARY>
