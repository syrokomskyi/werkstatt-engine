/*
<MODULE_CONTRACT>
<purpose>inspection — certification status inspection command returning the current gate result.</purpose>
<non-goals>
  <item>Do not mutate certification state — inspection is read-only.</item>
</non-goals>
</MODULE_CONTRACT>
<CHANGE_SUMMARY>
