/*
<MODULE_CONTRACT>
<purpose>component schemas — Zod schemas for component declaration validation and parsing.</purpose>
<non-goals>
  <item>Do not register components — this module defines the schema only.</item>
</non-goals>
</MODULE_CONTRACT>
<CHANGE_SUMMARY>
...
const componentScopeSchema = z.enum([
  "per-command",
  "per-mission",
  "per-session",
  "per-workshop",
