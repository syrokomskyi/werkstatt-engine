/*
<MODULE_CONTRACT>
<purpose>capability-artifacts store — persist and load capability artifact provenance records.</purpose>
<non-goals>
  <item>Do not evaluate artifact content — the store only persists provenance.</item>
</non-goals>
</MODULE_CONTRACT>
<CHANGE_SUMMARY>
