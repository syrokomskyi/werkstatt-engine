...
<KEY_DECISIONS>
  <item>The manifest is generated, not hand-maintained — docs/command-manifest.generated.yaml is the single output.</item>
  <item>Command metadata comes from the registry, not from doc parsing.</item>
</KEY_DECISIONS>
<CHANGE_SUMMARY>
