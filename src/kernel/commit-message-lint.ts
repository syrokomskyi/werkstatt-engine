...
<KEY_DECISIONS>
  <item>Lint rules are declarative patterns — new rules are data, not code branches.</item>
  <item>A commit message is validated as text only — no git operations are performed.</item>
</KEY_DECISIONS>
<CHANGE_SUMMARY>
