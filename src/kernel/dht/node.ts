...
<KEY_DECISIONS>
  <item>The node wraps @libp2p/kad-dht — S/Kademlia hardening is configured, not reimplemented.</item>
  <item>Lifecycle is explicit start/stop — the node never self-terminates.</item>
</KEY_DECISIONS>
<CHANGE_SUMMARY>
