...
<KEY_DECISIONS>
  <item>Module registers commands only — DHT logic lives in the sibling handler modules.</item>
  <item>All commands are workspace-scoped — no app context is required.</item>
</KEY_DECISIONS>
<CHANGE_SUMMARY>
