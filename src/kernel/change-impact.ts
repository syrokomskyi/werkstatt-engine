...
<KEY_DECISIONS>
  <item>Impact class derives from changed paths, not diff content — classification stays cheap.</item>
  <item>Advisory check profiles are suggestions, not gates — the caller decides what runs.</item>
</KEY_DECISIONS>
<CHANGE_SUMMARY>
