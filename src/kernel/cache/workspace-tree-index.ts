...
<KEY_DECISIONS>
  <item>The tree index is a single in-memory map — rebuilt on demand rather than persisted.</item>
  <item>mtimeMs is the staleness signal — content hashes are deliberately not tracked.</item>
</KEY_DECISIONS>
<CHANGE_SUMMARY>
