/*
<MODULE_CONTRACT>
<purpose>evolution controller — drive evolution stages through their guards and reducers.</purpose>
<non-goals>
  <item>Do not evaluate guards inline — the controller delegates to guards.ts.</item>
</non-goals>
</MODULE_CONTRACT>
<CHANGE_SUMMARY>
