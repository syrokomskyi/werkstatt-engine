...
export const evolutionModule: KernelModule = {
  name: "evolution",
  version: "0.1.0",
  ...
  async register(registry) {
    ...
    registry.registerCommand({
      ...
      flags: {
        ...
        "artifact": { kind: "string", description: "Content-addressed artifact hash (sha256:...)." },
        "allow-agent-written": { kind: "boolean", description: "Allow agent-authored candidates (default: false)." },
      },
    ...
    registry.registerCommand({
      ...
      flags: {
        ...
        "scenarios": { kind: "string", description: "Path to evaluation scenarios (default: src/evolution/fixtures)." },
      },
    ...
    registry.registerCommand({
      ...
      flags: {
        ...
        "traffic-percent": { kind: "string", description: "Percentage of traffic to route (default: 10)." },
      },
