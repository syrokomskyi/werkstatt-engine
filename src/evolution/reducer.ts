/*
<MODULE_CONTRACT>
<purpose>evolution reducer — reduce evolution events into the reducer state machine state.</purpose>
<non-goals>
  <item>Do not emit events — the reducer only folds them.</item>
</non-goals>
</MODULE_CONTRACT>
<CHANGE_SUMMARY>
