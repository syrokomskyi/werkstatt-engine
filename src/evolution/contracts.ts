/*
<MODULE_CONTRACT>
<purpose>evolution contracts — evolution stage and transition contract type definitions.</purpose>
<non-goals>
  <item>Do not evolve — this module defines the contract only.</item>
</non-goals>
</MODULE_CONTRACT>
<CHANGE_SUMMARY>
