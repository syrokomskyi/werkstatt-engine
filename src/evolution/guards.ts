/*
<MODULE_CONTRACT>
<purpose>evolution guards — guard results gating evolution stage transitions between states.</purpose>
<non-goals>
  <item>Do not transition — guards only permit or deny.</item>
</non-goals>
</MODULE_CONTRACT>
<CHANGE_SUMMARY>
