/*
<MODULE_CONTRACT>
<purpose>Maintains packages/fingerprint/src/tests/fixtures/ts-meaningful.after.ts as an authored fingerprint test module so agents can evolve it without rediscovering local boundaries.</purpose>
<non-goals>
