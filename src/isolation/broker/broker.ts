/*
<MODULE_CONTRACT>
<purpose>isolation broker — broker policy for routing isolation requests to providers.</purpose>
<non-goals>
  <item>Do not isolate directly — the broker selects the provider.</item>
</non-goals>
</MODULE_CONTRACT>
<CHANGE_SUMMARY>
