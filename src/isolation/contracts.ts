/*
<MODULE_CONTRACT>
<purpose>isolation contracts — isolation property kinds and contract type definitions.</purpose>
<non-goals>
  <item>Do not isolate — this module defines the contract only.</item>
</non-goals>
</MODULE_CONTRACT>
<CHANGE_SUMMARY>
